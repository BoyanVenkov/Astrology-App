...
export const screens: Record<ScreenKey, string> = {
  ...
  'scr.ritual.sound.silent': 'Тишина',
  'scr.ritual.soundTone': 'Тонът от {hz} Hz звучи отдолу.',
  'scr.ritual.soundMusic': 'Мек, бавно движещ се ембиънт акорд.',
  'scr.ritual.soundSilent': 'Без звук — само гласово или екранно напътствие.',
