...
export const screens: Record<ScreenKey, string> = {
  ...
  'scr.ritual.sound.silent': 'Bakuli pekee',
  'scr.ritual.soundTone': 'Sauti ya masafa ya {hz} Hz inacheza chini ya mabakuli.',
  'scr.ritual.soundMusic': 'Kodi ya mazingira laini, inayosogea polepole chini ya mabakuli.',
  'scr.ritual.soundSilent': 'Mabakuli yanayoimba pekee yanayoashiria kila hatua.',
