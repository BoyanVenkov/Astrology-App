...
export const screens = {
  ...
  'scr.ritual.sound.silent': 'Bowls only',
  'scr.ritual.soundTone': 'The {hz} Hz frequency tone plays underneath the bowls.',
  'scr.ritual.soundMusic': 'A soft, slow-moving ambient chord under the bowls.',
  'scr.ritual.soundSilent': 'Just the singing bowls that mark each step.',
