...
export const screens: Record<ScreenKey, string> = {
  ...
  'scr.ritual.sound.silent': 'Silenzio',
  'scr.ritual.soundTone': 'Il tono di frequenza da {hz} Hz suona sotto.',
  'scr.ritual.soundMusic': 'Un accordo ambientale morbido e lento.',
  'scr.ritual.soundSilent': 'Nessun suono — solo guida parlata o sullo schermo.',
