...
export const screens: Record<ScreenKey, string> = {
  ...
  'scr.ritual.sound.silent': 'Silence',
  'scr.ritual.soundTone': 'La tonalité de fréquence de {hz} Hz joue en dessous.',
  'scr.ritual.soundMusic': 'Un accord d’ambiance doux et lent.',
  'scr.ritual.soundSilent': 'Aucun son — guidance parlée ou à l’écran seulement.',
