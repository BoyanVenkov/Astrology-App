...
export const screens: Record<ScreenKey, string> = {
  ...
  'scr.ritual.sound.silent': 'Solo cuencos',
  'scr.ritual.soundTone': 'El tono de frecuencia de {hz} Hz suena bajo los cuencos.',
  'scr.ritual.soundMusic': 'Un acorde ambiental suave y lento bajo los cuencos.',
  'scr.ritual.soundSilent': 'Solo los cuencos tibetanos que marcan cada paso.',
