...
export const screens: Record<ScreenKey, string> = {
  ...
  'scr.ritual.sound.silent': 'केवल कटोरे',
  'scr.ritual.soundTone': '{hz} Hz का आवृत्ति-स्वर कटोरों के नीचे बजता है।',
  'scr.ritual.soundMusic': 'कटोरों के नीचे एक कोमल, धीरे बहती परिवेशी तान।',
  'scr.ritual.soundSilent': 'बस हर चरण को चिह्नित करने वाले गायन-कटोरे।',
