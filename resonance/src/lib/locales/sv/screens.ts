...
export const screens: Record<ScreenKey, string> = {
  ...
  'scr.ritual.sound.silent': 'Tyst',
  'scr.ritual.soundTone': 'Frekvenstonen på {hz} Hz spelar under.',
  'scr.ritual.soundMusic': 'En mjuk, långsamt rörlig ambient-ackord.',
  'scr.ritual.soundSilent': 'Inget ljud — endast talad eller skärmvägledning.',
