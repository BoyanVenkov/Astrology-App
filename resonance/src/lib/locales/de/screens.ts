...
export const screens: Record<ScreenKey, string> = {
  ...
  'scr.ritual.sound.silent': 'Nur Schalen',
  'scr.ritual.soundTone': 'Der {hz}-Hz-Frequenzton spielt unter den Schalen.',
  'scr.ritual.soundMusic': 'Ein weicher, langsam sich bewegender Ambient-Akkord unter den Schalen.',
  'scr.ritual.soundSilent': 'Nur die Klangschalen, die jeden Schritt markieren.',
