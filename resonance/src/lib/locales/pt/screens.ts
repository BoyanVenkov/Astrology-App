...
export const screens: Record<ScreenKey, string> = {
  ...
  'scr.ritual.sound.silent': 'Só tigelas',
  'scr.ritual.soundTone': 'O tom de frequência de {hz} Hz toca sob as tigelas.',
  'scr.ritual.soundMusic': 'Um acorde ambiente macio e lento sob as tigelas.',
  'scr.ritual.soundSilent': 'Só as tigelas tibetanas que marcam cada passo.',
  ...
  'notif.confirm.title': 'Notificações ativadas',
  'notif.confirm.body':
    'Você vai receber aqui sua leitura, os relaxamentos noturnos e os eventos do céu.',
