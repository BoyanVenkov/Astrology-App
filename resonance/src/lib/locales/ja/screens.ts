...
export const screens: Record<ScreenKey, string> = {
  ...
  'scr.ritual.sound.silent': '無音',
  'scr.ritual.soundTone': '{hz} Hz の周波数トーンが下で鳴ります。',
  'scr.ritual.soundMusic': 'やわらかく、ゆっくり動くアンビエントの和音。',
  'scr.ritual.soundSilent': '音なし — 話されるか画面上のガイダンスのみ。',
